...
$string['configtitle'] = 'الکتروآسا';
$string['connectus'] = 'تماس با ما';
...
$string['defaultphoneno'] = '989155253009';
...
$string['footnotedefault'] = 'p>شرکت  الکتروآسای بیهق با اتکا به خداوند بزرگ و تلاش و کوشش کارکنان عزیز و با اتکا به مجموعه یی سختکوش و قوی، دلسوزانه در راستای تحقق اهداف بلند پیش روی صنعت کشور گام بر داشته است.
این شرکت يكي از شركت‌هاي مهندسي ايراني است كه با اتكاء به تجارب غني و با ارزش حاصله از اجراي پروژه‏هاي عظيم در حال حاضر از لحاظ كادر تخصصي، اطلاعات فني- كارشناسي، آمادگي پذيرش و اجراي خدمات فنی مهندسی خدمات در قالب انواع  سیستم های روشنایی با هدف کاهش مصرف و بهینه سازی و سیستم های آبنما به شكل مستقل و يا با همكاري شركت‌هاي مشاوره‏اي و سازنده را در داخل و خارج ايران اسلامي دارا مي‌باشد.
- ادامه در : http://elasa.ir/fa#sthash.UXvLLPkl.dpuf
<br><a href="elasa.ir">ادامه در  &raquo;</a></p';
