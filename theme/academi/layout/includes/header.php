  ...
  <div class="header-main">
  	<div class="container-fluid">
    	<div class="row-fluid">
      	...
      	<div class="span7">
        	<div class="infoarea">          	
            <span><i class="fa fa-phone"></i>تماس با ما: <?php echo theme_academi_get_setting('phoneno'); ?></span>
            <span><i class="fa fa-envelope-o"></i>ایمیل: <?php echo theme_academi_get_setting('emailid'); ?></span>
          </div>
        </div>
      </div>
    </div>
